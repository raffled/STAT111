...
These two types of measures tell us about how the variable is *distributed* among our individuals. The *distribution* helps us answer questions like:
...
Remember that when we talk about skew we're talking about the **unusual** points, not that majority.
...
- The mean is always more affected by outliers than the median
...
So if both pairs of measures are good for symmetric data, and the median and IQR beat out the mean and standard deviation for skewed data, aren't the median and IQR always the better choice?
